...
\begin{itemize}[leftmargin=*]
  ...
  \item object IDs for \code{PaperProofRoot}, \code{TypeRegistry}, \code{FeeManager}, \code{GovernanceVault}, \code{GovernanceConfig}, and \sui{} \code{Clock};
...
Inline comments MUST be non-empty and no larger than the tree's \code{max\_onchain\_comment\_bytes}, whose default is 512 bytes. Blob comments MUST include non-empty blob ID and blob digest and MAY include a content preview. Blob comment limits are:
...
\code{protocolVersion} & \breakcode{publishing-v2-governance-v2-comments-v2} \\
\code{pprf package} & \breakcode{0x5d2ec9829a9e116de7c2008281a90b96690beb2252af120ad05a25fe13fae0da} \\
\code{publishing package} & \breakcode{0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782} \\
